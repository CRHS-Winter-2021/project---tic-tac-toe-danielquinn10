...
def checkWin(board,player):
  ...
  rowT1 = (theBoard[7] == player and theBoard[8] == player and theBoard[9] == player)

  #Win in middle row for Player
  rowM1 = (theBoard[4] == player and theBoard[5] == player and theBoard[6] == player)

  #Win in bottom row for Player
  rowB1 = (theBoard[1] == player and theBoard[2] == player and theBoard[3] == player)

  #Win in left column for Player
  colL1 = (theBoard[7] == player and theBoard[4] == player and theBoard[1] == player)

  #Win in middle column for Player
  colM1 = (theBoard[8] == player and theBoard[5] == player and theBoard[2] == player)

  #Win in right column for Player
  colR1 = (theBoard[9] == player and theBoard[6] == player and theBoard[3] == player)

  #Win in top left diagonal for Player
  diaL1 = (theBoard[7] == player and theBoard[5] == player and theBoard[3] == player)

  #Win in top right diagonal for Player
  diaR1 = (theBoard[9] == player and theBoard[5] == player and theBoard[1] == player)
...
def checkFull(board):
    if theBoard[1] != " " and theBoard[2] != " " and theBoard[3] != " " and theBoard[1] != " " and theBoard[4] != " " and theBoard[5] != " " and theBoard[6] != " " and theBoard[7] != " " and theBoard[8] != " " and theBoard[9] != " ":
      return True
...
def welcome():
  ...
  while play == "help":
    global theBoard
    print("The main objective of this game is to get 3 in a row before your opponent. You will take turns playing in one of the 9 available space. These are the numbers that correspond to each space: ")
